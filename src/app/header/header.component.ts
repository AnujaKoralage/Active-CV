  ...
  async share() {
    try{
      await this.ngNavigatorShareService.share({
        title: "Live Resume - Anuja Koralage",
        text: "Hello, I'm a Full-stack Java Web Developer with 2+ years of experience designing web and mobile projects. Find out more in my live-resume!",
        url: "https://anujakoralage.com"
      });
    } catch(error) {
